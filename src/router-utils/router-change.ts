import {Subject, of,merge, Subscription, Observable} from "rxjs";
...
export class RouterChangeService {
  ...
  immediateWatch:Observable<ChangeRoute> = merge<string, ChangeRoute>(
...
export const routerChangeService=new RouterChangeService();